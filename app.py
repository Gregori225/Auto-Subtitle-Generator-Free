...
def ui1():
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            with gr.Column():
                upload_media = gr.File(label="Upload Audio or Video Files", file_count="multiple")
            ...
            with gr.Column():
              ...
              customized_srt = gr.File(label="📝 Readable Subtitles (Multi-line)", file_count="multiple")
              ...
              with gr.Accordion("🌍 Other Subtitle Formats", open=False):
                  word_level_srt = gr.File(label="🔠 Word-by-Word Subtitles", file_count="multiple")
                  shorts_srt     = gr.File(label="📱 Shorts/Reels Subtitles", file_count="multiple")
                  transcript_txt = gr.File(label="📄 Full Transcript (Text File)", file_count="multiple")
                  translated_srt = gr.File(label="🌐 Translated Subtitles", file_count="multiple")
        ...
        generate_btn.click(
            ...
            outputs=[customized_srt,transcript_box,word_level_srt,shorts_srt,transcript_txt,translated_srt]
        )
