...
def temp_demo(media_file, source_lang, target_lang):
    default_srt, translated_srt_path, custom_srt, word_srt,shorts_srt, txt_path,sentence_json,word_json, transcript=subtitle_maker(media_file, source_lang, target_lang)
    return (custom_srt,transcript,word_srt,shorts_srt,txt_path,translated_srt_path)
